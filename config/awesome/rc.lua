...
for s = 1, screen.count() do
    ...
    tags[s] = awful.tag({ " eins ", " zwei ", " drei " }, s, layouts[1])
end
-- }}}
...
vicious.register(batwidget, vicious.widgets.bat, '<span>| $1$2% |</span>', 1, "BAT1")
...
vicious.register(volume, vicious.widgets.volume, '<span>| $1db </span>', 0.1, "Master")
...
globalkeys = awful.util.table.join(
    ...
    awful.key({  }, "XF86AudioLowerVolume", function () awful.util.spawn("amixer set Master 6%-",    false) end),
